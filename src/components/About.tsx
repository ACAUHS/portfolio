...
export const About = () => {
    return (
        <div className="bg-whiter flex flex-col h-screen justify-center items-center gap-8">
            <div className="header font-face-bsr text-4xl underline decoration-inherit decoration-2 underline-offset-4">About</div>
            <div className="main-section flex items-center gap-10 justify-center">
                <div className="container font-face-bsr text-xl w-1/4">
